...
```sh
python3 -B -m unittest discover -s /Users/amanraj/.codex/skills/ente-workflow-checks/scripts -p 'replay_*.py'
```
...
```sh
python3 -B /Users/amanraj/.codex/skills/ente-workflow-checks/scripts/checks.py snapshot --repo /absolute/checkout --snapshot /tmp/task-before.json
python3 -B /Users/amanraj/.codex/skills/ente-workflow-checks/scripts/checks.py unchanged --repo /absolute/checkout --snapshot /tmp/task-before.json
```
...
```sh
python3 -B /Users/amanraj/.codex/skills/ente-workflow-checks/scripts/check_file_contract.py --repo /absolute/checkout --contract /tmp/task-files.json
```
...
```sh
python3 -B /Users/amanraj/.codex/skills/ente-workflow-checks/scripts/checks.py run --repo /absolute/checkout --cwd server --receipt /tmp/task-test.json -- ./scripts/test-with-postgres.sh host
python3 -B /Users/amanraj/.codex/skills/ente-workflow-checks/scripts/checks.py verify --repo /absolute/checkout --receipt /tmp/task-test.json
```
...
```sh
python3 -B /Users/amanraj/.codex/skills/ente-workflow-checks/scripts/checks.py pr --repo /absolute/checkout --contract /tmp/task-pr.json
```
...
```sh
python3 -B /Users/amanraj/.codex/skills/ente-workflow-checks/scripts/check_api_origin.py --har /tmp/task-network.har --expected-origin http://localhost:8080 --api-path-prefix /public-collection/
```
...
```sh
python3 -B /Users/amanraj/.codex/skills/ente-workflow-checks/scripts/check_task.py prd --prd /absolute/checkout/.task/PRD.md
```
...
```sh
python3 -B /Users/amanraj/.codex/skills/ente-workflow-checks/scripts/check_task.py diff --repo /absolute/checkout --base <full-base-commit-sha>
```
